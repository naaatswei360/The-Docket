...
export const guideFinalExercise = {
  ...
  // Seeds the editable Word simulator for this exercise — the learner types
  // the citation straight into the footnote pane instead of a plain textarea.
  sim: {
    bodyText: "The tribunal's power to hear this case derives from the authority below.",
    footnoteNum: 1,
    footnotePlaceholder: 'Type the full OSCOLA citation here…',
  },
};
